...
2. **Bộ chọn phương tiện (Media Selector):**
   - 3 nút bấm lớn: _Tải ảnh lên_, _Chụp ảnh_, _Quay video_.
...
3. **Khung xem trước & Đánh giá chất lượng (`PreparedFrame`):**
   ...
   - Nút bấm: _"Upload ảnh và tạo job"_.
...
`MushroomRecognitionScreen` là mục đầu tiên và là màn hình mặc định của `HomeScreen`.
